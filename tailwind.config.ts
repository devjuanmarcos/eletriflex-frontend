    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          ...
          lightest: "hsl(var(--brand-primary-lightest))",
  ...
  plugins: [
    ...
    function ({ addUtilities }: any) {
      const newUtilities = {
        ...
        ".display-01": { fontWeight: "700", fontSize: "4.5rem", lineHeight: "1" },
        ".display-02": { fontWeight: "700", fontSize: "4rem", lineHeight: "1" },
        ".heading-01": { fontWeight: "700", fontSize: "3.5rem", lineHeight: "1" },
        ".heading-02-bold": { fontWeight: "700", fontSize: "3rem", lineHeight: "1" },
        ".heading-02-medium": { fontWeight: "500", fontSize: "3rem", lineHeight: "1" },
        ".heading-02": { fontWeight: "500", fontSize: "3rem", lineHeight: "1" },
